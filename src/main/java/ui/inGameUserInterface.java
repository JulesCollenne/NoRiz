...
public class inGameUserInterface {
    ...
    private Image UITimer = new Image("UITimer.png", 119, Utils.caseDimension * 2, true, false);
    private Image UIRiceTemp = new Image("UIRiceTemp.png", 119, Utils.caseDimension * 2, true, false);
    private Image UIHeart = new Image("UIHeart.png", 52.7, Utils.caseDimension + (Utils.caseDimension/2.0), true, false);
    private Image grainDeRiz = new Image("GrainDeRiz.png", 52.7, Utils.caseDimension + (Utils.caseDimension/2.0), true, false);
