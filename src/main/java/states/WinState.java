...
public class WinState extends GameState {
    ...
    public void init() {
        ...
        ModeButton menu = new ModeButton(new Image("sign_menu.png"), "Menu");
        menu.setLayoutX((new Image("sign_return_menu.png").getWidth()/2));
        menu.setLayoutY((40/100.0)*Utils.canvasSize);
        menu.handler(gsm);

        ModeButton niveau_suivant = new ModeButton(new Image("sign_niveau_suivant.png"), "Niveau_Suivant");
        niveau_suivant.setLayoutX( (((2*Utils.canvasSize)/3.0) + Utils.canvasSize)/2 - (new Image("sign_menu.png").getWidth()/2));
